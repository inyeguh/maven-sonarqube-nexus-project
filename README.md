...
- https://github.com/inyeguh/Devop-CICD-project/blob/maven-nexus-sonarqube-jenkins-install/nexus-install.sh

## Install Apache Maven
- https://github.com/inyeguh/Devop-CICD-project/blob/maven-nexus-sonarqube-jenkins-install/maven-install.md

## Install SonarQube
- https://github.com/inyeguh/Devop-CICD-project/blob/maven-nexus-sonarqube-jenkins-install/sonarqube-install.sh
